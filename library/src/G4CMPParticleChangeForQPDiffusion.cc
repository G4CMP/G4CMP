...
G4Step* G4CMPParticleChangeForQPDiffusion::
UpdateStepForAlongStep(G4Step* pStep) {
...
G4Step* G4CMPParticleChangeForQPDiffusion::
UpdateStepForPostStep(G4Step* pStep) {
...
void G4CMPParticleChangeForQPDiffusion::DumpInfo() const {
...
G4bool
G4CMPParticleChangeForQPDiffusion::CheckIt(const G4Track& aTrack){
