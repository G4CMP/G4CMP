...
public:
  ...
  static void SetPrimaryPhononEnergy(G4double value) { Instance()->EprimPhonons = value; }
...
private:
  ...
  G4double EprimPhonons; // Energy assigned to primary phonons ($G4CMP_EPRIM_PHONONS)
