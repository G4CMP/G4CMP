...
ValidationQubitHousing(G4RotationMatrix * pRot,const G4ThreeVector & tLate,
  ...
  //(and which we'll access in our main detector construction file.)
  ConstructQubitHousing(pRot,tLate,pName,pMotherLogical,pMany,pCopyNo,pSurfChk);

  
}

// Default Constructor
ValidationQubitHousing::ValidationQubitHousing()
{  
}
                      ...
                      G4bool pMany,G4int pCopyNo,G4bool pSurfChk)
{
  ...
  //Need to add back in corners under the cutouts. Need to do some math here
  //to get this right...
